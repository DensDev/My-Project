...
<div class="isikanan"><!--Awal class isi kanan-->
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/pmb_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/pmb_edit.php";
		break;
		
		case "jenkel":
			include "aplikasi/pmb_jenkel.php";
		break;
		
		case "pencarian":
			include "aplikasi/pmb_pencarian.php";
		break;
		
		case "cetak":
			include "aplikasi/pmb_cetak.php";
		}
		?>
