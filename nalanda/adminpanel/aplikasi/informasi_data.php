...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			<div class="menuhorisontalaktif-ujung"><a href="informasi_kampus.php">Informasi Kampus</a></div>
		...
		<?php 	$namasekolah=mysql_query("SELECT * FROM sh_pengaturan WHERE id_pengaturan=8");
			...
			<tr><td class="isiankanan" width="100px">Nama Kampus</td><td class="isian"><input type="text" name="nama_sekolah" class="sedang" <?php echo "value='$ns[isi_pengaturan]'";?>></td></tr>
		...
		<?php 	$kepsek=mysql_query("SELECT * FROM sh_pengaturan WHERE id_pengaturan=11");
			...
			<tr><td class="isiankanan" width="100px">Pimpinan Kampus</td><td class="isian"><input type="text" name="kepala_sekolah" class="sedang" <?php echo "value='$k[isi_pengaturan]'";?>></td></tr>
			
		<?php 	$alamatsekolah=mysql_query("SELECT * FROM sh_pengaturan WHERE id_pengaturan=12");
				$a=mysql_fetch_array($alamatsekolah);?>
			<tr><td class="isiankanan" width="100px">Alamat Kampus</td><td class="isian"><textarea name="alamat_sekolah" style="height:125px; width: 60%"><?php echo "$a[isi_pengaturan]";?></textarea></td></tr>
