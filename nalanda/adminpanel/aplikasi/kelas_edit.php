...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			<div class="menuhorisontal"><a href="mahasiswa.php">Mahasiswa</a></div>
			<div class="menuhorisontal"><a href="alumni.php">Alumni</a></div>
			<div class="menuhorisontalaktif"><a href="program_studi.php">Program Studi</a></div>
		</div>
		...
		?>
			...
			<tr><td class="isiankanan" width="175px">Program Studi</td><td class="isian"><input type="text" name="nama_kelas" class="maksimal" value="<?php echo "$r[nama_kelas]";?>"></td></tr>
