...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		?>
			...
			<tr><td class="isiankanan" width="175px">Mata Kuliah</td><td class="isian"><b><a href=""><?php echo "$r[nama_mapel]";?></a></b></td></tr>
			<tr><td class="isiankanan" width="175px">Dosen Pengampu</td><td class="isian"><b><a href=""><?php echo "$r[nama_gurustaff]";?></a></b></td></tr>
