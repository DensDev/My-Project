...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<form method='POST' <?php echo "action='$database?pilih=mapel&untukdi=edit'"; ?> name='editmapel' id='editmapel' >
			...
			<tr><td class="isiankanan" width="175px">Nama Mata Kuliah</td><td class="isian"><input type="text" name="nama_mapel" class="maksimal" <?php echo "value='$r[nama_mapel]'"; ?>></td></tr>
