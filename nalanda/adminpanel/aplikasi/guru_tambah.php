...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<form method='POST' <?php echo "action='$database?pilih=guru&untukdi=tambah'";?> name='tambahguru' id='tambahguru' enctype="multipart/form-data">
			...
			<tr><td class="isiankanan" width="175px">Nama Dosen</td><td class="isian"><input type="text" name="nama_guru" class="maksimal"></td></tr>
			<tr><td class="isiankanan" width="175px">NIY</td><td class="isian"><input type="text" name="nip" class="pendek"></td></tr>
