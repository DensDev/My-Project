...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<form method='POST' <?php echo "action='$database?pilih=siswa&untukdi=tambah'";?> name='tambahsiswa' id='tambahsiswa' >
			...
			<tr><td class="isiankanan" width="175px">Nama Mahasiswa</td><td class="isian"><input type="text" name="nama_siswa" class="maksimal"></td></tr>
			<tr><td class="isiankanan" width="175px">NIM</td><td class="isian"><input type="text" name="nis" class="pendek"></td></tr>
			...
			<tr><td class="isiankanan" width="175px">Program Studi</td>
			<td class="isian">
					<select name="kelas">
			...
			<tr><td class="isiankanan" width="175px">Status Mahasiswa</td>
			<td class="isian">
