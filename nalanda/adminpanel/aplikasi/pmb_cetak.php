...
<h3>Cetak Laporan PMB</h3>
<div class="isikanan"><!--Awal class isi kanan-->
								
		<div class="judulisikanan">
			<div class="menuhorisontalaktif-ujung"><a href="pmb_online.php">Pendaftar</a></div>
			<div class="menuhorisontal"><a href="pmb_diterima.php">Diterima</a></div>
			<div class="menuhorisontal"><a href="pmb_setting.php">Pengaturan</a></div>
		</div>
		...
		<tr><td class="isiankanan" width="250px">Semua Data PMB</td><td class="isian"><input type="button" class="batal" value="Cetak xls &raquo;" onclick="window.location.href='konten/laporan-psb.php';"></td></tr>
