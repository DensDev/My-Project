...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			<div class="menuhorisontalaktif-ujung"><a href="mahasiswa.php">Mahaiswa</a></div>
		...
		<form method='POST' <?php echo "action='$database?pilih=siswa&untukdi=edit'";?>  name='editsiswa' id='editsiswa' >
			...
			?>
			<tr><td class="isiankanan" width="175px">Nama Mahasiswa</td><td class="isian"><input type="text" name="nama_siswa" class="maksimal" value="<?php echo "$r[nama_siswa]";?>"></td></tr>
			<tr><td class="isiankanan" width="175px">NIM</td><td class="isian"><input type="text" name="nis" class="pendek"value="<?php echo "$r[nis]";?>"></td></tr>
