...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			<div class="menuhorisontalaktif-ujung"><a href="dosen_staff.php">Dosen</a></div>
		...
		?>
			...
			<tr><td class="isiankanan" width="175px">Nama Dosen</td><td class="isian"><input type="text" name="nama_guru" class="maksimal" value="<?php echo"$r[nama_gurustaff]";?>"></td></tr>
			<tr><td class="isiankanan" width="175px">NIY</td><td class="isian"><input type="text" name="nip" class="pendek" value="<?php echo"$r[nip]";?>"></td></tr>
