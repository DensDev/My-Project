...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<form method='POST' action="<?php echo "$database";?>" name='editpengaturan' id='editpengaturan' >
			...
			?>
			<tr><td class="isiankanan" width="100px">Perbolehkan pengunjung melihat data Mahasiswa</td><td class="isian">
			...
			<tr><td class="isian" colspan="2" style="color:#7f7f7f;"><i>
			Jika anda memlilih <b>Ya</b>, maka pengunjung akan dapat melihat detail setiap data, jika anda memilih <b>Tidak</b> maka pengunjung hanya dapat melihat Nama mahasiswa, JK dan Kelas
			</i><br><hr></td></tr>
			...
			?>
			<tr><td class="isiankanan" width="100px">Perbolehkan pengunjung melihat data Dosen</td><td class="isian">
