...
<div class="isikanan"><!--Awal class isi kanan-->
		...
		<div class="judulisikanan">
			<div class="menuhorisontalaktif-ujung"><a href="mahasiswa.php">Mahasiswa</a></div>
			<div class="menuhorisontal"><a href="alumni.php">Alumni</a></div>
			<div class="menuhorisontal"><a href="program_studi.php">Program Studi</a></div>
		</div>
		...
		<div class="atastabel" style="margin-bottom: 10px">
			...
			<form method="POST" style="float: left" action="siswa.php?pilih=kelas">
				<select name="kelas" onChange="this.form.submit()">
					<option value="" selected>Tampil Berdasarkan Program Studi</option>
					<?php
		...
		<table class="tabel" id="results">
			<tr>
				...
				<th class="tabel">Program Studi</th>
			...
			<tr class="tabel"><td class="tabel" colspan="8"><b>DATA MAHASISWA BELUM TERSEDIA</b></td></tr>
			<?php }
			?>
		</table>
    ...
    //--></script>
		...
		case "tambah":
			include "aplikasi/mahasiswa_tambah.php";
		break;
		
		case "edit":
			include "aplikasi/mahasiswa_edit.php";
		break;
		
		case "jenkel":
			include "aplikasi/mahasiswa_jenkel.php";
		break;
		
		case "kelas":
			include "aplikasi/mahasiswa_kelas.php";
		break;
		
		case "pencarian":
			include "aplikasi/mahasiswa_pencarian.php";
		}
		?>
