...
<div id="wrapper"><!--Awal id wrapper-->
	...
	<div id="konten"><!--Awal id konten-->
		<div id="samping"><!--Awal id samping-->
			...
			<div class="menu"><div class="isimenuGuru"><a href="guru_staff.php">Dosen dan Staff</a></div></div>
			<div class="menu"><div class="isimenuSiswa"><a href="mahasiswa.php">Mahasiswa</a></div></div>
			<div class="menu"><div class="isimenuMapel"><a href="mata_pelajaran.php">Mata Kuliah</a></div></div>
		...
		<div id="kanan"><!--Awal id kanan-->
					...
					<?php include "aplikasi/mahasiswa_data.php"; ?>
