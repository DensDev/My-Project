...
<html>
<head>
<title>Admin STAB Nalanda Panel</title>
...
<body style="text-align: center; background: url(images/nld.jpg)" id="login" OnLoad="document.login.username.focus();">
<img src="images/logo_nalanda.png" style="margin-top: 10%;">
<div id="kotakLogin">
...
$tahun=date("Y");
?>
<font style="font-size:11px; color: #2e2e2e">&copy; <?php echo "$tahun";?>, <a>Design and Develops by</a> Dennis Dahlin</font>
</body>
</html>
<?php } } ?>