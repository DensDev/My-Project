		<div class="judulbox">Polling PMB</div>
		
		<table class="isian" style="margin:10px;">
		<tr><td>
		Berikut adalah data polling dari total pendaftar online, data berikut merupakan hasil dari pertanyaan <b>Darimanakah anda mengetahui PMB ONLINE <?php echo "$ns[isi_pengaturan]";?> ?</b>
		</td></tr></table>
