		...
		?>
			...
			<tr><td class="isiankanan" style="width: 10px;"><?php echo "$jmlkelas"; ?></td><td class="isian"><a href="kelas.php">Semester</a></td>
			...
			<tr><td class="isiankanan" style="width: 10px;"><?php echo "$jmlsiswa"; ?></td><td class="isian"><a href="siswa.php">Mahasiswa</a></td>
			...
			<tr><td class="isiankanan" style="width: 10px;"><?php echo "$jmlguru"; ?></td><td class="isian"><a href="guru_staff.php">Dosen</a></td>
