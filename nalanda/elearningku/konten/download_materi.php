...
?>
		<table style="margin: 20px 0 20px 0;" class="garis">
			...
			<tr class="form"><td><b>Dosen Pengampu</b></td><td><input type="text" class="panjang" value="<?php echo $data[nama_gurustaff]?>" disabled></td></tr>
			...
			<tr class="form"><td><b>Mata Kuliah</b></td><td><input type="text" class="panjang" value="<?php echo $data[nama_mapel]?>" disabled></td></tr>
