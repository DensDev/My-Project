		...
		<?php } ?>
		<div class="menuMapel"><a href="?p=mapel">Mata Kuliah</a></div>
		<div class="menuGuru"><a href="?p=guru">Dosen</a></div>
		...
		?>
		<ul>
		<li><b><?php echo $jmlsiswa?></b> Jumlah Mahasiswa</li>
		<li><b><?php echo $jmlguru?></b> Jumlah Dosen</li>
		<li><b><?php echo $jmlmapel?></b> Jumlah Mata Kuliah</li>
