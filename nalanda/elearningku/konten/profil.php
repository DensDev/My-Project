...
?>		<form method="POST" action="proses.php?pilih=guru&untukdi=edit" name="editprofil" id="editprofil">
		...
		<table style="margin: 20px 0 20px 0;">
			<tr class="form"><th class="garis" colspan="3" style="text-align: center">Data Dosen</th></tr>
...
?>		<form method="POST" action="proses.php?pilih=siswa&untukdi=edit" name="editprofil" id="editprofil">
		...
		?>
		<table style="margin: 20px 0 20px 0;">
			<tr class="form"><th class="garis" colspan="3" style="text-align: center">Data Mahasiswa</th></tr>
			<tr class="form"><td><b>Nama</b></td><td><input type="text" class="panjang" value="<?php echo $ps[nama_siswa]?>" disabled></td></tr>
			<tr class="form"><td><b>NIM</b></td><td><input type="text" class="panjang" value="<?php echo $ps[nis]?>" disabled></td></tr>
			<tr class="form"><td><b>Semester</b></td><td><input type="text" class="panjang" value="<?php echo $ps[nama_kelas]?>" disabled></td></tr>
			<tr class="form"><td><b>Password</b></td><td>
