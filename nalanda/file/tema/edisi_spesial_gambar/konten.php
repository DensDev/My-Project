...
<div id="konten">
<div id="lebar">
<h3>Data Dosen <a href=""><?php echo "$ns[isi_pengaturan]";?></a></h3>
...
<div id="konten">
<div id="lebar">
<h3>Pendaftaran Mahasiswa Baru Online <a href=""><?php echo "$ns[isi_pengaturan]";?></a></h3>
<?php
...
?>
<br>
<p>Sekilas Informasi PMB Online 
...
if ($r[nama_pengaturan]==1){
?>
<h3>Form Pendaftaran Mahasiswa Baru <a href=""><?php echo "$ns[isi_pengaturan]";?></a></h3>
...
<table style="margin-top: 20px">
	...
	<tr><td colspan="3" style="border: 1px dashed #5b5b5b; padding: 20px;background: #fcffea;"><b>Darimanakah anda mengetahui PMB ONLINE <a href=""><?php echo "$ns[isi_pengaturan]"?></a></b><br><br>
