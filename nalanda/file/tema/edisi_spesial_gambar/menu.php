<ul>
			...
			<li><a href="">Profil</a>
				...
				<?php $profil=mysql_query("SELECT * FROM sh_info_sekolah WHERE posisi_menu='0' AND status_terbit='1' ORDER BY id_info ASC");
					...
					<?php }?>
					<li><a href="?p=gmap">Lokasi Kampus</a></li>
				</ul>
			</li>
			<?php
