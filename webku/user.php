...
<div style="margin:auto">
	...
	<a href="update.php" class="left">Tambah User</a> <a href="logout.php" class="right">Logout</a>
	<br />
	<table class="view">
		<thead>
			<tr>
			...
			<tr class="<?php if ($i % 2 == 0) { echo "odd"; } else { echo "even"; } ?>">
				...
				<td>
					...
					<div class="row-actions">
						<a href="edit.php?uid=<?php echo $data['id_daftar'];?>">Edit</a>
						<?php if ($data['username'] != 'admin') {?>
						 | <a href="delete.php?uid=<?php echo $data['id_daftar'];?>" class="delete">Delete</a>
						<?php } ?>
					</div>
					<?php } ?>
				</td>
